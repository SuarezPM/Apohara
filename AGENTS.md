...
This project is indexed by GitNexus as **Clarity-Code** (3877 symbols, 8442 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

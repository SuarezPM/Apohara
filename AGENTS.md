...
This project is indexed by GitNexus as **Clarity-Code** (3591 symbols, 7941 relationships, 218 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

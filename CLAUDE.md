...
This project is indexed by GitNexus as **Clarity-Code** (3675 symbols, 8106 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
